...
//     #(.comp_t(%s), .activity_t(activity_%p));", 
    ...
    m_out_prv->println("");
    m_out_prv->println("function new(import_api api=null);");
    m_out_prv->inc_ind();
    ...
    m_out_prv->inc_ind();
    m_out_prv->println("api = new();");
    m_out_prv->dec_ind();
    m_out_prv->println("end");
    m_out_prv->println("");
    m_out_prv->println("foreach(listeners[i]) begin");
    m_out_prv->inc_ind();
    m_out_prv->println("listeners[i].enter_actor(this);");
    m_out_prv->dec_ind();
    m_out_prv->println("end");
    m_out_prv->println("");
    ...
    m_out_prv->println("foreach(listeners[i]) begin");
    m_out_prv->inc_ind();
    m_out_prv->println("listeners[i].leave_actor(this);");
    m_out_prv->dec_ind();
    m_out_prv->println("end");
    m_out_prv->dec_ind();
