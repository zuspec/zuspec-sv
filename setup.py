...
zuspec_sv_dir = os.path.dirname(os.path.abspath(__file__))

if os.path.isdir(os.path.join(zuspec_sv_dir, "packages")):
    print("Packages are inside this directory")
    packages_dir = os.path.join(zuspec_sv_dir, "packages")
else:
...
#                os.path.join(zuspec_sv_dir, 'python', "EvalBackendClosure.cpp"), 
#                os.path.join(zuspec_sv_dir, 'python', "EvalThreadData.cpp"), 
            ],
            language="c++",
            include_dirs=[
